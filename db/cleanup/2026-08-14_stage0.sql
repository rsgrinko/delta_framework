-- ВЫПОЛНЕНО 2026-08-14. Скрипт оставлен для истории и для применения на других окружениях.
-- Удалено 25 сниппетов кода и две пустые таблицы; рабочие данные не затронуты.
--
